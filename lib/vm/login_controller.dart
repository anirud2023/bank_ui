...
class LoginController extends GetxController{
  ...
  final RxString errorValidLastName=''.obs;
   ...
   bool corrName=false;
   bool corrPass=false;
   bool corrConfirmPass=false;
   bool corrLastName=false;
 ...
 void isValidPassword(String value){
   ...
   if (value.isEmpty) {
     ...
     errorPassword.value = 'Password must contain at least one uppercase letter';
   } else if (!value.contains(RegExp(r'[a-z]'))) {
     errorPassword.value =
 ...
 void isConfPassSame(String value){
   if(validPassword.value==validConfirmPass.value){
     ...
     errorConfirmPass.value='Matched';
   }
 }
